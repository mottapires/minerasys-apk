...
class ApontadorScreen extends StatefulWidget {
  const ApontadorScreen({super.key});

  @override
  State<ApontadorScreen> createState() => _ApontadorScreenState();
}

class _ApontadorScreenState extends State<ApontadorScreen> {
  ...
  Future<void> _salvarRegistro() async {
    ...
    try {
      ...
      await StorageService.instance.salvarApontador(
      ...
      await SyncService.syncApontador();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Apontador - Saída'),
